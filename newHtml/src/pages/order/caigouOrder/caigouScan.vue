<template>
    <div id="container" class="caigouScan">
        <div class="content">
...
export default {
                                ...
                                h('i', {style:{padding:'0.1333rem'},
                                    on: {
                                        click: () => {
                                            ...
                                            addCookie('caigouScanData',JSON.stringify(that.scanData),1);
                                        }
                                    }
                                }, '删除')
                            ]);
    ...
    methods:{
        load(){//加载缓存
            let that = this;
            that.scanData = getCookie('caigouScanData') ? JSON.parse(getCookie('caigouScanData')) : [];
            that.formItem.num = that.scanData.length;
...
<style>
    /* .caigouScan .content .cont_cont .cont_d .ivu-table-wrapper{
        border:none;
    } */
    .caigouScan .content .cont_cont .cont_d .ivu-table-wrapper .ivu-table{
        background:none;
    }
    .caigouScan .content .cont_cont .cont_d .ivu-table-wrapper .ivu-table th{
        text-align:center;
        color:#727171;
        background:#fff;
        height:1rem;
    }
    .caigouScan .content .cont_cont .cont_d .ivu-table-wrapper .ivu-table td{
        height:1rem;
    }
    .caigouScan .content .cont_cont .cont_d .ivu-table-wrapper .ivu-table .ivu-table-cell{
        padding-left:0;
        padding-right:0;
        text-align:center;
        font-size:0.32rem;
