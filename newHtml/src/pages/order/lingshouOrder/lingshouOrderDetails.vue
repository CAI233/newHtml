<template>
    <div id="container" class="lingshouOrderDetails">
        <div class="content">
            <div class="cont_c">
...
export default {
    ...
    methods:{
        load(no){//加载订单信息
            ...
            // }
            wxget('User/GetSellOrderByOrderNo/'+no).then(res =>{
                if(res.code == 200){
                    console.log(res);
...
<style>
    ...
    .lingshouOrderDetails .ivu-input,.lingshouOrderDetails .ivu-input:hover,.lingshouOrderDetails .ivu-input:focus{
        border:none;
        padding-top: 8px;
    }
</style>
