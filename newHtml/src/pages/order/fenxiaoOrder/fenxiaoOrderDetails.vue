<template>
    <div id="container" class="fenxiaoOrderDetails">
        <div class="content">
            <div class="cont_c">
...
export default {
    ...
    methods:{
        load(no){//加载订单信息
            ...
            // }else{
            //     url = 'User/GetSaleOrderByOrderNo/';
            // }
            wxget('User/GetSaleOrderByOrderNo/'+no).then(res =>{
                if(res.code == 200){
                    console.log(res);
...
<style>
    .fenxiaoOrderDetails .ivu-form .ivu-form-item-label{
        padding-right: 0;
        text-align: left;
        font-size:0.3733rem;
        color:#727171;
    }
    .fenxiaoOrderDetails .ivu-input,.fenxiaoOrderDetails .ivu-input:hover,.fenxiaoOrderDetails .ivu-input:focus{
        border:none;
        padding-top: 0.16rem;
    }
</style>
