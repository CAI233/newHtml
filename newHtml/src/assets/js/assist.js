 ...
 * @param user
 */
function setLoginUser (user,token) {
  localStorage.setItem(sessionUser, JSON.stringify(user))
  addCookie(cookieToken, token, 24)
}
export {setLoginUser}
/**
...
function getLoginUser () {
  return localStorage.getItem(sessionUser) ? JSON.parse(localStorage.getItem(sessionUser)) : '';
}
export {getLoginUser}
...
function getPageAuth () {
  return JSON.parse(localStorage.getItem(sessionUser)).pageIdsObj
}
export {getPageAuth}
